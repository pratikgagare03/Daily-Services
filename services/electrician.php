<?php
    ...
    $sql = "SELECT * FROM worker where category='electrician' && city='$city' && verified = True";
...
<body>
    ...
    <div class="nav">
        ...
        <div class="heading">
            <h1>Best Electricain Service Near You</h1>
        </div>
    ...
    <script>
        ...
        if(js_data.length === 0){
            document.getElementById("output").innerHTML += `<h2 class="error"> Currently Electrician Service is Not availbale at your location </h2>`;
        }
