<?php
    ...
    $sql = "SELECT * FROM worker where category='carpenter' && city='$city' && verified = True";
...
<body>
    <div class="tempMain">
        ...
        <div class="heading">
            <h1>Best Carpanter Service Near You</h1>
        </div>
    ...
    <script>
        ...
        if(js_data.length === 0){
            document.getElementById("output").innerHTML += `<h2 class="error"> Currently Carpenter Service is Not availbale at your location </h2>`;
        }
